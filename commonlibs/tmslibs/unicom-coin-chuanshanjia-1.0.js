...
const UnicomCSJCoinAd = { 
    ...
    *       taskId:"任务id",    
    ...
    showToutiaoVideoAd: function(configJO){ 
        ...
        //接收回调数据
        UnicomCSJCoinAd.showToutiaoVideoAd.onComplete = function (data) { 
        ...
        //接收回调数据
        UnicomCSJCoinAd.showToutiaoVideoAd.onError = function () {
